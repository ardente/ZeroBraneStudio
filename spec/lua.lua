...
return {
  ...
  keywords = {
    ...
    -- constants/variables
    [[_G _VERSION _ENV io.stderr io.stdin io.stdout math.huge math.pi
    package.cpath package.path package.searchpath package.seeall package.config package.loaded package.loaders package.preload package.searchers]],
